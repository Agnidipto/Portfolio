...
function ResponsiveAppBar(props) {
  ...
  const color = Math.min(scrollPosition / 150,1);

  const shadow1opacity = Math.min(scrollPosition / 750, 0.2);
  const shadow2opacity = Math.min(scrollPosition / 1071.42, 0.14);
  const shadow3opacity = Math.min(scrollPosition / 1250, 0.12);
  const boxShadow = `0px 2px 4px -1px rgba(0,0,0,${shadow1opacity}), 0px 4px 5px 0px rgba(0,0,0,${shadow2opacity}), 0px 1px 10px 0px rgba(0,0,0,${shadow3opacity})`;
